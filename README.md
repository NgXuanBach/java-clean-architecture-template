# 🏛️ Java Clean Architecture Template
...
*   **Database:** PostgreSQL (can be easily swapped)
...
1. Clone the repository:
   [git clone https://github.com](https://github.com/NgXuanBach/java-clean-architecture-template.git)
2. Build all modules:
   mvn clean install
